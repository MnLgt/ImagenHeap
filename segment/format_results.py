...
def format_results(masks, boxes, scores, phrases, **kwargs):
    results_dict = []
    ...
    for mask, box, score, phrase, polygon in zip(
        masks, boxes, scores, phrases, polygons
    ):
        results_row = dict(
            mask=mask, box=box, score=score, phrase=phrase, polygons=polygon
        )
